...
function main() {
    ...
    const bundlePath = path.join(__dirname, "../static/lib/agui-chat-react/agui_chat_widget.12.0.8.8.1.js");
    const cssPath = path.join(__dirname, "../static/lib/agui-chat-react/agui_chat_widget.12.0.8.8.1.css");

    assert(manifest.includes('"version": "12.0.8.8.1"'));
    ...
    assert(!assets.includes("agui_chat_widget.12.0.8.8.1.css"));
    ...
    assert(surfaces.includes("agui_chat_widget.12.0.8.8.1.css"));
